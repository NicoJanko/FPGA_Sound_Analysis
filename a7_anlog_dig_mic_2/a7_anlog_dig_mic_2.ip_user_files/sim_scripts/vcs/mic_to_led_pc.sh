...
#
# Script generated by Vivado on Tue May 27 09:48:47 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mic_to_led_pc.sh
...
#
# Usage        : mic_to_led_pc.sh
#                mic_to_led_pc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mic_to_led_pc.sh [-reset_run]
#                mic_to_led_pc.sh [-reset_log]
#                mic_to_led_pc.sh [-help]
#
...
#                script (type 'mic_to_led_pc.sh -help' for more information).
#
...
# script info
echo -e "mic_to_led_pc.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mic_to_led_pc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../Cmod\\ A7/a7_anlog_mic_1/a7_anlog_dig_mic_2/a7_anlog_dig_mic_2.srcs/sources_1/imports/a7_anlog_mic_1/adc_to_uart.v" \
  "../../../../../../Cmod\\ A7/a7_anlog_mic_1/a7_anlog_dig_mic_2/a7_anlog_dig_mic_2.srcs/sources_1/imports/a7_anlog_mic_1/mic_to_led.v" \
  "../../../../../../Cmod\\ A7/a7_anlog_mic_1/a7_anlog_dig_mic_2/a7_anlog_dig_mic_2.srcs/sources_1/imports/a7_anlog_mic_1/uart.v" \
  "../../../../../../Cmod\\ A7/a7_anlog_mic_1/a7_anlog_dig_mic_2/a7_anlog_dig_mic_2.srcs/sources_1/imports/a7_anlog_mic_1/mic_to_led_pc.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mic_to_led_pc xil_defaultlib.glbl -o mic_to_led_pc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mic_to_led_pc_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mic_to_led_pc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mic_to_led_pc_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mic_to_led_pc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mic_to_led_pc.sh [-help]\n\
Usage: mic_to_led_pc.sh [-step]\n\
Usage: mic_to_led_pc.sh [-lib_map_path]\n\
Usage: mic_to_led_pc.sh [-reset_run]\n\
Usage: mic_to_led_pc.sh [-reset_log]\n\
Usage: mic_to_led_pc.sh [-keep_index]\n\
Usage: mic_to_led_pc.sh [-noclean_files]\n\n\
