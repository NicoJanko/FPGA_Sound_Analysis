...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot mic_to_led_pc xil_defaultlib.mic_to_led_pc xil_defaultlib.glbl -log elaborate.log
}
