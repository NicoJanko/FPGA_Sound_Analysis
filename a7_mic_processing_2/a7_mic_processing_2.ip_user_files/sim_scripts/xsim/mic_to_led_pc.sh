...
#
# Script generated by Vivado on Thu Jun 05 08:56:39 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L fifo_generator_v13_2_11 -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_19 -L mult_gen_v12_0_22 -L axi_utils_v2_0_10 -L cordic_v6_0_23 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot mic_to_led_pc xil_defaultlib.mic_to_led_pc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mic_to_led_pc -key {Behavioral:sim_1:Functional:mic_to_led_pc} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_11 xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 c_addsub_v12_0_19 mult_gen_v12_0_22 axi_utils_v2_0_10 cordic_v6_0_23)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mic_to_led_pc.wdb xsim.dir libdpi.so)
