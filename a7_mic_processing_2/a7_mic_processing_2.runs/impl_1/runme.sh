...
HD_PWD='C:/Users/Nicolas Jankovsky/Documents/CytoMEMS/FPGA_Simulation/CMOD_A7_35T/FPGA_Sound_Analysis/a7_mic_processing_2/a7_mic_processing_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_to_led_pc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mic_to_led_pc.tcl -notrace
