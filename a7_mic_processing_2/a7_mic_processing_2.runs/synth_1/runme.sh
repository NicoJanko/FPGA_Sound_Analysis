...
HD_PWD='C:/Users/Nicolas Jankovsky/Documents/CytoMEMS/FPGA_Simulation/CMOD_A7_35T/FPGA_Sound_Analysis/a7_mic_processing_2/a7_mic_processing_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mic_to_led_pc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mic_to_led_pc.tcl
